...
export const postCopiarActividades = async (id_pme, new_id_pme, year) => await axios.post(`${import.meta.env.VITE_API}/recursos/copiar/actividades/${id_pme}/${new_id_pme}/${year}`);
